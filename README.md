...
style. This assignment is an opportunity to show off your domain modeling, OO and

design skills to produce an elegant, readable and testable solution. Please do not submit a

multi-threaded or real-time solution. Please do use what you would consider best practice
...
2) If using Java, the jar file that results from the Source Code should run with JDK 1.6.
...
Note: Morningstar email system will reject any executable attachments like jar, exe

etc. Please send the files in a compressed format or upload them to something
