...
public class ShopTest {
	...
	public void testPendingCustomersAfter14() {
		...
		assertEquals("After 14 sec there should be 4 pending items", 4, (int) cashier.normalizedPendingItems);
		assertTrue(!shop.isDone());
	}
	...
	public void testPendingCustomersAfterOvershoot() {
		...
		assertEquals("After 18 sec there should be 0 pending items", 0, (int) cashier.normalizedPendingItems);
		assertTrue(shop.isDone());
	}
